...
export const deadline = {
    ...
    initialVote: new Date('2024-05-14T08:00:00'), //tempo inicial de votacao
    finalVote: new Date('2024-05-14T10:00:59'), //tempo final de votacao
    finalLoginTime: new Date('2024-05-14T10:50:00'), // tempo final de login
...
export const snackbarConsts = {
    ...
    validationSuccess: {
        ...
        description:
            'A hash fornecida é válida e corresponde a votos registrados.',
        color: '#9fc54d',
    },
    ...
    registerSuccess: {
        ...
        description:
            'Solicitação enviada com sucesso, favor aguardar aprovação!.',
        color: '#9fc54d',
    },
    ...
    fileContentError: {
        ...
        description:
            'Erro ao carregar comprovante, tente novamente mais tarde.',
        color: '#ff6464',
    },
    validationError: {
