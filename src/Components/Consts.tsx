...
export const deadline = {
  initialVote: new Date("2024-05-21T08:00:00"), //tempo inicial de votacao
  finalVote: new Date("2024-05-21T17:00:59"), //tempo final de votacao
  finalLoginTime: new Date("2025-05-21T16:50:00"), // tempo final de login
